 ...
 */
export const patternsAndPracticesForAnalysis: Section = {
  type: 'section',
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              type: 'paragraph',
              content:
                '<div class="paragraph">\n<p>ATAM has been successfully applied by many organizations to a variety of systems. It is widely regarded as the most important systematic approach to qualitative system/architecture analysis <sup class="footnote">[<a id="_footnoteref_7" class="footnote" href="#_footnotedef_7" title="View footnote.">7</a>]</sup>.</p>\n</div>'
            }
          ]
        },
        {
