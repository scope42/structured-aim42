 ...
 */
export const slideOrWriteAtomic: Atomic<Section> = {
  type: 'section',
  slug: 'slide-or-write',
  id: 'Slide-Or-Write',
  sectionType: 'section',
